...
./aws-s3-uploader -p "$output_files_dir"/*/*/hhid*.csv -b daap-hh-count 
./aws-s3-uploader -p "$output_files_dir"/*/*/tv_*.csv -b daap-viewership-reports -b daap-viewership-reports -z=true
